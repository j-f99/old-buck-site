  ...
  return (
    <section id="hero" className="relative group h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-30 text-center px-6 sm:px-12 lg:px-8 max-w-5xl mx-auto flex flex-col items-center">
        ...
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_center,rgba(4,30,66,0.8)_0%,rgba(4,30,66,0.4)_40%,transparent_80%)] pointer-events-none opacity-90 group-hover:opacity-100 transition-opacity duration-1000" />
